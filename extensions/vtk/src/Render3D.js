...
function botones(isBoolean) {
  console.log('Botones: ' + isBoolean);
}
    ...
    return (
      <div>
        ...
        {/* <div className="col-xs-12">
          <h5 style={{ color: '#fff' }}>{progressString}</h5>
        </div> */}
